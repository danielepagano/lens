...
def main() -> None:
    ...
    print()
    slug = _PROJECT_DIR.name
    print("  Quick checks:")
    print(f"    curl {api_url}/health               # global liveness")
    print(f"    curl {api_url}/projects              # list projects")
    print(f"    curl {api_url}/{slug}/health         # per-project health")
    print(f"    curl {api_url}/{slug}/stats")
    print(f"    curl {api_url}/{slug}/narrative/tree")
    print()
    print("  CLI:")
