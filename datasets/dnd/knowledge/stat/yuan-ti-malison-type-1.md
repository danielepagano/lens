**Yuan-ti Malison (Type 1)** · Medium Monstrosity, Neutral Evil

**AC** 12 · **HP** 66 · **Speed** 30 ft., climb 30 ft. (snake form only)
...
At Will: Animal Friendship (snakes only)2/Day: Suggestion
...
Type 1. These malisons have human bodies and the heads of giant, venomous snakes.Type 2. These malisons have human bodies, but they’ve replaced their arms with snakes.Type 3. These malisons are human from the waist up, but below that extend the coils of a giant snake.
...
[source: https://www.dndbeyond.com/monsters/5195290-yuan-ti-malison-type-1]: #