# Grim Hollow — Setting Guide

Etharis is a dark fantasy continent where the gods are dead, magic is feared, and every realm teeters on the edge of collapse. This is not grimdark nihilism — hope exists, but it is scarce, hard-won, and often paid for in blood. Small acts of courage and kindness stand out precisely because they are rare.

## Core Truths of Etharis

These shape every interaction, NPC, and scene in the setting:

- **The gods are dead.** The last four destroyed each other in the Gods' End. Divine healing is scarce; resurrection is near-impossible. Apothecaries and surgeons have replaced temples. Characters wielding divine magic are anomalies — treated with awe, suspicion, or hostility depending on who's watching.
- **Magic is feared and persecuted.** Arcane magic draws power from a parallel dimension called Numena, and each spell cast may thin the veil between planes. Commoners blame mages for the world's ills. The Arcanist Inquisition hunts practitioners in Castinella; Bürach licenses and heavily regulates them; Ostoya's vampires claim magic as their exclusive right. Only Charneault's elves and Morencia's refugees treat magic with respect.
- **Arch Seraphs and Arch Daemons fill the divine void** — but they are not gods. They embody only narrow aspects of their predecessors' domains (valor, not war; fear, not caution), making their edicts extreme and unyielding. Who counts as Seraph versus Daemon is culturally dependent — there are no gods left to arbitrate morality.
- **Humanity is desperate and flawed.** Help is not given freely. Bribery, coercion, and blackmail are better understood than appeals to mercy. Even good people commit terrible acts to survive. An innkeeper's hospitality may hide poison; a lord's protection comes at a price.
- **Monsters are real and numerous.** Travel between settlements is dangerous. Monster hunter guilds have corporatized the trade. The common folk cower behind walls while horrors stalk freely.
- **Hope is the point.** A dark setting makes heroism meaningful. Hard-fought victories, won at steep cost, deserve celebration. The question is always: what are you willing to sacrifice?

## The Peoples of Etharis

Humans dominate after the Era of Expansion's bloody conquests displaced the elder peoples. Elves hold Charneault's forests, dwarves keep their mountain fortresses, dragonborn are scattered since Ember Cairn's fall, gnomes and halflings persist in niches. Rare heritages — dreamers, wulven, dhampir, disembodied, downcast — provoke fear and suspicion. Mutative magic makes physiological diversity common even within species. See `lore.grim-hollow-folk-of-etharis` for all heritages.

## The Cosmology

- **Numena**: Parallel dimension, source of arcane magic. May be the realm of the Aether Kindred. Each spell thins the veil.
- **The Heavens**: Rebuilt as a fortress by the Arch Seraphs after the Aetheric War. No mortal access; attempts end in catastrophe.
- **The Netherworld**: Hell-domains of the Arch Daemons, each reflecting its lord's nature. Only for the dead — travel is one-way unless dark magic intervenes.
- **Realm of Faerie (Feywild)**: Stitched into the Material Plane. Four seasonal courts. Capricious archfey may be fallen seraphs. Gateway to elven origins.
- **Ethereal Plane**: The river between all planes. The city of Ulmyr's Gate was destroyed trying to open a permanent portal here.
- **Primordial Realms**: Four elemental planes (Flamebourne, Endless Sea, Stonereach, Whispering Void). Source of primal magic. The Primordials (Morakesh, Alondo, Citrolach, Ilhara) rule them — children of the slumbering Great Prismatic Wyrm, Gormadraug, whose awakening would unmake the world.
- **Aether Kindred**: Incomprehensible cosmic horrors (Vraigoroth, M'rorcameleth, Pharazorthok) that destroyed most of the gods. They may be waking again.
