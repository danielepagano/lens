**Curse of Uncontrollable Wrath** · 6th-level Enchantment

**Casting Time**: 1 Hour
**Range**: Unlimited
**Components**: V, S, M ((blood or other fluid of the target, a severed hand, and a serrated knife worth 1,000+ GP, all of which the spell consumes))
...
Triggering Event. The next time the cursed creature wields a weapon or Spellcasting Focus in battle, an old wound reopens, and the curse advances to Stage 1.
