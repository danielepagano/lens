**Curse of Ravenous Hunger** · 3rd-level Enchantment

**Casting Time**: 1 Hour
**Range**: Unlimited
**Components**: V, S, M ((a morsel of food that belonged to the target, a sun-dried slug, and a dining plate worth 400+ GP, all of which the spell consumes))
...
Stage 2. The cursed creature becomes compelled to eat inappropriate items such as coins, flowers, glass, and dirt. Additionally, the cursed creature has Disadvantage on Constitution saving throws, and its Hit Point maximum decreases by an amount equal to its character level or Hit Dice.
