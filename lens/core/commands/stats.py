...
class StatsResult:
    ...
    release_major_update_pending: bool = False
    release_major_update_target_version: str = ""
    release_major_update_approved: bool = False
...
def get_stats(session: ProjectSession, *, verbose: bool = False) -> StatsResult:
    ...
    if not is_dataset:
        ...
        release_cfg = ReleaseConfig(
            ...
            major_update_pending=rs.major_update_pending,
            major_update_target_version=rs.major_update_target_version,
            major_update_approved=rs.major_update_approved,
    ...
    return StatsResult(
        ...
        release_major_update_pending=release_cfg.major_update_pending,
        release_major_update_target_version=release_cfg.major_update_target_version,
        release_major_update_approved=release_cfg.major_update_approved,
