...
def stats(project_slug: str, session: ProjectSession = Depends(get_session)) -> dict[str, Any]:
    ...
    return {
        ...
        "release": {
            ...
            "major_update_pending": result.release_major_update_pending,
            "major_update_target_version": result.release_major_update_target_version,
            "major_update_approved": result.release_major_update_approved,
